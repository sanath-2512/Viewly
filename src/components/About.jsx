...
const About = () => {
  return (
    <div>
        ...
        <h1>🎬 Features</h1>
        <ul>
        <li>Search movies using The Movie <strong> TMDB API</strong></li>
        ...
        <h1>👨‍💻 Developer</h1>
        <p>
        This project was built by <strong>Sanath Waraikar</strong>, a CS & AI student passionate about frontend and full-stack development. Viewly is part of his <strong>React learning journey.</strong>
        </p>
        <h1>📬 Get in Touch</h1>
